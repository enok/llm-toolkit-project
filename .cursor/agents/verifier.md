---
name: verifier
description: Validates completed work. Use proactively after tasks are marked done; run in parallel with other reviewers. Confirms implementations exist, tests pass, and claims match reality.
model: fast
readonly: true
---
