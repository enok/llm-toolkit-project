---
name: tcc-deliverables
description: |
  Use for any change that affects thesis-facing evidence, figures, tables, chapter
  conclusions, or methodology explanations in the Public Compliance Data Analysis
  thesis. For USP MBA TCC deliverable expectations.
metadata:
  author: enok
  version: "1.0.0"
---
...
Use this skill for any change that affects thesis-facing evidence, figures, tables, chapter conclusions, or methodology explanations.

Apply the shared `research-thesis-support` skill first. This skill captures thesis-specific deliverable expectations for this repository.
