---
name: course-material-grounding
description: |
  Use when the task asks about MBA classes, lecture materials, class-derived methods,
  or how the local `aulas/` corpus should influence analysis choices. For USP MBA
  Data Science & Analytics coursework alignment.
metadata:
  author: enok
  version: "1.0.0"
---
...
Use this skill when the task asks about MBA classes, lecture materials, class-derived methods, or how the local `aulas/` corpus should influence analysis choices.

## Source Of Truth

- Treat `<path-to-course-materials>` as the primary source corpus in this environment.
...
- Keep USP MBA course mappings, thesis framing, and class-specific method preferences in project context.
...
- For thesis-facing tasks, pair course guidance with `usp-mba-course-context` skill and `tcc-deliverables` skill.
- For data and modeling work, pair course guidance with shared skills on reproducibility, dataset governance, notebook engineering, and ML experimentation.
