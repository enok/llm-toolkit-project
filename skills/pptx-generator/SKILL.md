...
metadata:
  ...
  source: https://github.com/MiniMax-AI/skills/tree/main/pptx-generator
  sources:
...
- Python: markitdown with PPTX support for text extraction
- Node.js: `pptxgenjs` for creating presentations
- Optional icons: react-icons, react, react-dom, sharp
