...
description: |
  Repository-specific security check requirements for the Public Compliance Data
  Analysis project. Defines the minimum security review gate for changes in this
  repository.
metadata:
  author: enok
  version: "1.0.0"
...
This skill defines the repository-specific minimum security review gate for changes made in this repository and for related work in `dev-tools`.
