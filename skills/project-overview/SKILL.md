...
description: |
  Project overview and context for the Public Compliance Data Analysis repository.
  MBA thesis focused on public spending efficiency, compliance risk, and anomaly
  detection in Brazil. Use for understanding repository structure, scope, and
  working assumptions.
metadata:
  author: enok
  version: "1.0.0"
...
The shared toolkit includes guidance for technologies that are not primary in this repository. Do not spend context on them unless the task truly needs them:
