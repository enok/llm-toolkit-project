---
name: data-pipeline-boundaries
description: |
  Repository-specific guidance for data pipeline boundaries in the Public Compliance
  Data Analysis project. Use after the shared data-pipeline skill for understanding
  Bronze/Silver/Gold layer boundaries and contract files.
metadata:
  author: enok
  version: "1.0.0"
---
...
Use this skill after the shared `data-pipeline` skill for understanding contract sources and boundary decisions specific to this repository.
