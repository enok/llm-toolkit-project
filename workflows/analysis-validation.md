---
description: Validate analytical outputs (numbers, figures, tables, claims) before they support thesis conclusions
---
...
- `tcc-analysis-and-writing-sync.md` — For integrating into thesis
- `bilingual-notebook-sync.md` — For EN/pt-BR pairs
- `tcc-method-selection.md` — For choosing methods initially
