---
description: End-to-end completion guide for the MBA thesis: remaining chapters, analyses, deliverables, and submission order
---
...
- `bilingual-notebook-sync.md` — For notebook pairs
- `workflows/bilingual-doc-sync.md` — For documentation files
- `tcc-analysis-and-writing-sync.md` — For analysis-writing alignment
...
- `tcc-analysis-and-writing-sync.md` — Writing sync workflow
- `tcc-method-selection.md` — Method selection guidance
- `tcc-deliverables` skill — Deliverable expectations
- `usp-mba-course-map` reference — MBA course grounding
